...
from flask import current_app, redirect, request, url_for, session, Blueprint, render_template
...
def init_auth_routes(auth_bp: Blueprint) -> None:
    """Initialize authentication routes.
    
    Args:
        auth_bp: Flask Blueprint instance for authentication routes
    """
